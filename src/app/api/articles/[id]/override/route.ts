...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    // ADMIN-only - beda adari /review (EDITOR || ADMIN). FR-AM-09 eksplisit "Admin", bukan editor+.
    ...
    // Selalu revalide halaman publik - override bisa membuat artikel hilang/muncul dari publik di kedua arah.
